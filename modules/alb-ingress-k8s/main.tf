  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::${data.aws_caller_identity.current.account_id}:oidc-provider/oidc.eks.us-east-1.amazonaws.com/id/B9C1FDFF21CF68957E72BAF28E54E005"
      },
...
data "template_file" "alb_config" {
  template = "${file("${path.module}/files/alb_ic_values.yaml")}"
  vars = {
    ALB_ROLE_ARN = aws_iam_role.alb.arn
  }
}

resource "helm_release" "alb_ic" {
